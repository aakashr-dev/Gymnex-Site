    ...
    <header className="h-16 bg-dark-surface/80 border-b border-white/10 px-6 flex items-center justify-between sticky top-0 z-20 backdrop-blur-md">
      ...
      <div className="relative w-64 md:w-80">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-1.5 bg-dark-card border border-white/10 rounded-xl text-xs text-white placeholder:text-gray-500 focus:outline-none focus:border-amber-500 transition-colors"
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="p-2 rounded-xl bg-dark-card border border-white/10 text-gray-300 hover:text-white hover:border-amber-500/40 transition-colors relative"
          >
        ...
        {/* Role Pill */}
        <Badge variant={role === 'Admin' ? 'amber' : role === 'Trainer' ? 'amber' : 'green'}>
          {role}
        </Badge>
      </div>
      ...
      <Modal isOpen={qrModalOpen} onClose={() => setQrModalOpen(false)} title="GYMNEX Digital Access Pass">
        <div className="text-center space-y-4 py-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-amber-500 font-mono tracking-widest">ID: GYM-ACCESS-99210</p>
