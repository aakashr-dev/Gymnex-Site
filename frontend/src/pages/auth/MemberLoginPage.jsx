...
import { User, ArrowRight, Lock, Target, QrCode, Activity } from 'lucide-react';
...
export const MemberLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Invalid member credentials. Please try again.');
    }
  };
          ...
          <Card className="p-8 space-y-6 shadow-2xl border-amber-500/30 bg-dark-surface/95 backdrop-blur-xl relative">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-xs text-gray-400 font-sans">
                Access your digital VIP membership pass, class reservations, diet plans, and workout logs.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
              ...
              <Button
                ...
                icon={ArrowRight}
              >
                {loading ? 'Accessing Member Dashboard...' : 'Sign In To Personal Pass'}
              </Button>
            </form>
