...
import { UserCheck, ArrowRight, Lock, Dumbbell, Calendar, Users } from 'lucide-react';

export const TrainerLoginPage = () => {
  const [email, setEmail] = useState('marcus.v@gymnex.com');
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      await login(email, password, 'Trainer');
      navigate('/trainer');
    } catch (err) {
      setError('Invalid trainer credentials. Please try again.');
    }
  };
          ...
          <Card className="p-8 space-y-6 shadow-2xl border-amber-500/30 bg-dark-surface/95 backdrop-blur-xl relative">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-xs text-gray-400 font-sans">
                Access client rosters, workout program builders, nutrition planners, and class schedules.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
              <div>
                ...
                <input
                  ...
                  placeholder="marcus.v@gymnex.com"
              ...
              <Button
                ...
                icon={ArrowRight}
              >
                {loading ? 'Authenticating Coach Portal...' : 'Enter Trainer Suite'}
              </Button>
            </form>
            ...
            <div className="pt-4 border-t border-white/10 flex items-center justify-between text-[11px] text-gray-400">
              ...
              <div className="flex items-center gap-3">
                <Link to="/auth/admin" className="text-amber-500 hover:underline font-extrabold">
                  Admin Portal →
                </Link>
