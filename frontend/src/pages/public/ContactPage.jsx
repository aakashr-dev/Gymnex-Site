      ...
      <div className="pt-28 pb-24 bg-dark-base min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            {/* Contact Form Card with Clean Athlete Background */}
            <Card className="lg:col-span-7 space-y-6 border-amber-500/30 bg-black/90 backdrop-blur-xl p-8 shadow-2xl relative overflow-hidden group">
              {/* Seamless Muscular Athlete Overlay - Black Box Edges Removed via Screen Blend */}
              <div
                className="absolute inset-0 bg-contain bg-center bg-no-repeat opacity-90 mix-blend-screen pointer-events-none transition-all duration-700 group-hover:opacity-100 scale-105"
                style={{ backgroundImage: `url('/contact-athlete-bg.png')` }}
              />
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-dark-card/90 border border-white/15 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-amber-500 transition-colors"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-dark-card/90 border border-white/15 rounded-xl text-white focus:outline-none focus:border-amber-500 transition-colors"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-4 py-3 bg-dark-card/90 border border-amber-500/40 text-amber-400 font-extrabold rounded-xl focus:outline-none focus:border-amber-400 transition-colors"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-dark-card/90 border border-white/15 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-amber-500 transition-colors font-mono"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-dark-card/90 border border-white/15 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-amber-500 transition-colors font-sans"
                    />
                  </div>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-dark-card border border-white/10 rounded-3xl p-6 space-y-4 shadow-xl">
                ...
                <div className="space-y-3 text-xs text-gray-300">
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-amber-500/30 transition-colors">
